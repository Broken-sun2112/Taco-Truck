...
public class StatisticsFrame extends javax.swing.JFrame {
    ...
    public void init(){
        ...
        jLabel5.setText(String.copyValueOf(dao.totalRevenue()));
        jLabel6.setText(String.valueOd(adminDao.getMaxRowAdminTable() - 1));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        for (double i = 0.1; i <= 1.0; i += 0.1) {
            ...
            try {
                ...
                Logger.getLogger(StatistcsFrameFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
